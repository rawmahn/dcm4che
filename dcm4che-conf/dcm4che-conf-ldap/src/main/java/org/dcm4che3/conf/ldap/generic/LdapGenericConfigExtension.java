...
/**
 * A generic Ldap ConfigurationExtension implementation that works for an
 * arbitrary config class annotated with @ConfigClass and @ConfigField
 * annotations. Config class must be provided both as a generic arg and as a
 * constructor arg.
 * 
 * @author Roman K
 * 
