...
/**
 * Marks a field of a configuration class as a configuration field, meaning that
 * it will be persisted. If a field of a config class is not annotated, it will
 * be skipped and NOT persisted.
 * 
 * @author Roman K
 * 
 */
...
public @interface ConfigField {
    ...
    /**
     * What is used as a map key, e.g. which names ldap nodes have like if a key
     * is 'name', then nodes are name=registry, name=repository
     * 
     * @return
     */
