...
public class X509CertificateAdapter implements ConfigTypeAdapter<X509Certificate, String> {
    ...
    @Override
    public X509Certificate fromConfigNode(String configNode, AnnotatedConfigurableProperty property, LoadingContext ctx, Object parent) throws ConfigurationException {
        try {
    ...
    @Override
    public String toConfigNode(X509Certificate object, AnnotatedConfigurableProperty property, SavingContext ctx) throws ConfigurationException {
        try {
