 ...
 * 
 */
public class ReflectiveAdapterOld<T> implements ConfigTypeAdapter<T, Map<String,Object>> {
    ...
    public ReflectiveAdapterOld(Class<T> clazz) {
        super();
        this.clazz = clazz;
    }

    public ReflectiveAdapterOld(Class<T> clazz, T providedConfObj) {
        super();
        this.clazz = clazz;
