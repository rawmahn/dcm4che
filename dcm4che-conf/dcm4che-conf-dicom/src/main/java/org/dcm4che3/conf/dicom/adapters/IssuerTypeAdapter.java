...
public class IssuerTypeAdapter extends DefaultConfigTypeAdapters.CommonAbstractTypeAdapter<Issuer> {
    ...
    @Override
    public Issuer fromConfigNode(String configNode, AnnotatedConfigurableProperty property, LoadingContext ctx, Object parent) throws ConfigurationException {
        return configNode == null || configNode.length() == 0 ? null : new Issuer(configNode);
    }

    @Override
    public String toConfigNode(Issuer object, AnnotatedConfigurableProperty property, SavingContext ctx) throws ConfigurationUnserializableException {
