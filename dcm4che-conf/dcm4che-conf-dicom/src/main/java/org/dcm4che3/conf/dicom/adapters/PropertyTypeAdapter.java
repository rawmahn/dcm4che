...
public class PropertyTypeAdapter extends DefaultConfigTypeAdapters.CommonAbstractTypeAdapter<Property> {
    ...
    @Override
    public Property fromConfigNode(String configNode, AnnotatedConfigurableProperty property, LoadingContext ctx, Object parent) throws ConfigurationException {
        return new Property(configNode);
    }

    @Override
    public String toConfigNode(Property object, AnnotatedConfigurableProperty property, SavingContext ctx) throws ConfigurationException {
